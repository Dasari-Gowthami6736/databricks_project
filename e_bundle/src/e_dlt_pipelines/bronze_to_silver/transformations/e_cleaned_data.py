...
volumne_path = f"/Volumes/{catalog_name}/e_bronze_layer/e_earthquake_volume"
primary_key="id"
...
@dlt.view(name="e_earthquake_data")
def earthquake_data():
    df = (
...
dlt.create_streaming_table(name="e_earthquake_data_final")

dlt.apply_changes(
    target="e_earthquake_data_final",
    source="e_earthquake_data",
    keys=[primary_key],
